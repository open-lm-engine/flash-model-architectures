...
mayank_training = MultiOutputPattern([view_default_5, view_default_9, permute_default_4, view_default_11])
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
mayank_inference = CallFunction(aten.view.default, bmm_default_1, Ignored(), _users=0)
