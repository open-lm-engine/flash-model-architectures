// file copied from https://github.com/karpathy/llm.c/blob/master/llmc/cuda_common.h
// with some irrelevant code removed
...
enum class DType : uint8_t { FP32, FP16, BF16 };
