...
def pad_sequence(x: torch.Tensor, cu_seqlens: torch.Tensor, max_seqlen: torch.Tensor | int) -> torch.Tensor:
...
def unpad_sequence(x: torch.Tensor, cu_seqlens: torch.Tensor) -> torch.Tensor:
    batch_size = cu_seqlens.size(0) - 1
