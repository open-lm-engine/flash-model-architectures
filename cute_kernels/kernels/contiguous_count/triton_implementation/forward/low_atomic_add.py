...
_KERNEL_NAME = "contiguous_count_low_atomic_add_triton"
...
def contiguous_count_low_atomic_add_triton(
    ...
    with torch.device(x.device):
        _contiguous_count_low_atomic_add_triton_kernel[(num_programs,)](
            x_ptr=x,
            output_ptr=output,
            B=B,
            C=size,
