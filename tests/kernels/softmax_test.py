...
class SoftmaxTest(TestCommons):
    ...
    def test_softmax(
        ...
        self.assert_equal_tensors(z_kernel, z_expected, False, atol_float32=4e-5, rtol_float32=0)
        self.assert_equal_tensors(x_kernel.grad, x_expected.grad, False, atol_bfloat16=3e-5, rtol_bfloat16=0)
